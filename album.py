...
def album_add(year, artist, genre, album):
    ...
    session.commit()
"""принимает запрос
 http -f POST http://localhost:8080/albums artist="Beatles" year="1963" genre="Rock and roll" album="Please Please Me"
 при передаче неверных или пустых данных возвращает ошибку с описанием """